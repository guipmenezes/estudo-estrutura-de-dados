...
public class Exercicios07 {
	...
	private static void imprimeTodosElementos(ArrayList<Contato> lista) {
		System.out.println(lista);
	}

	private static void excluiTodosElementos(ArrayList<Contato> lista) {
		lista.clear();
		System.out.println("Todos os contatos foram excluidos");
	}

	private static void imprimeTamanhoVetor(ArrayList<Contato> lista) {
		System.out.println("Tamanho do vetor eh de: " + lista.size());
	}

	
	//Me parece ser identico ao busca contato por posição
